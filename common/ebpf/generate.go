...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -no-global-types -target bpfel,bpfeb -tags with_ebpf -go-package bpfgen -output-dir internal/bpfgen -output-stem splice Splice native/splice.bpf.c
