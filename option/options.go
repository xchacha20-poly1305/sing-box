...
type _Options struct {
	...
	Schema               string                `json:"$schema,omitempty" examples:"https://raw.githubusercontent.com/reF1nd/sing-box/reF1nd-stable/docs/schema.json"`
...
func (o Options) DescribeSchema(builder schema.Builder) (*schema.Node, error) {
	...
	node.ID = "https://raw.githubusercontent.com/reF1nd/sing-box/reF1nd-stable/docs/schema.json"
