...
随本文档发布的 Schema 位于
[raw.githubusercontent.com/reF1nd/sing-box/reF1nd-stable/docs/schema.json](https://raw.githubusercontent.com/reF1nd/sing-box/reF1nd-stable/docs/schema.json)。
